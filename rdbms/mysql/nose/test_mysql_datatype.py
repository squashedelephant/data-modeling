...
class TestMySQLDataType(TestCase):
    ...
    def test_01_bit_min(self):
        ...
        self.assertEqual(int(Fixture.expected(inputs)),
                         int(b2a_hex(self.m.dql(Fixture.test(inputs))), 16))
    ...
    def test_18_float_precision(self):
        ...
        self.m.ddl(Fixture.load_schema(inputs))
        self.m.ddl(Fixture.populate(inputs))
        self.assertEqual(float(Fixture.expected(inputs)),
                         self.m.dql(Fixture.test(inputs)))
    ...
    def test_19_date_min(self):
        ...
        self.m.ddl(Fixture.load_schema(inputs))
        self.m.ddl(Fixture.populate(inputs))
        self.assertEqual(Fixture.expected(inputs),
                         str(self.m.dql(Fixture.test(inputs))))
    ...
    def test_31_varchar_max(self):
        ...
        self.m.ddl(Fixture.load_schema(inputs))
        self.m.ddl(Fixture.populate(inputs))
        self.assertEqual(''.join(Fixture.expected(inputs)),
                         self.m.dql(Fixture.test(inputs)))
